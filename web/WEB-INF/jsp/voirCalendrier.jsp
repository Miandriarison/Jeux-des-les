        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="publicVoir" class="nav-item nav-link active"><i class= "fa fa-table me-2"></i>Voir les calendriers</a>
                    <a href="publicVoirmedaille" class="nav-item nav-link"><i class= "fa fa-table me-2"></i> Voir le tableau des médailles</a>
                    <a href="crudRDD" class="nav-item nav-link"><i class= "fa fa-table me-2"></i>  recettes et dépenses par discipline</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="filtreCalendrier" method="get">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select type="text" class="form-control" id="inputEmail3" name="iddisciplines">
                                            ...
                                            <option value="<% out.print(disciplines.elementAt(i).getNom()); %>"><% out.print(disciplines.elementAt(i).getNom()); %></option>
                                            <% } %>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><% out.print(v_calendrier.elementAt(i).getDateFormat()); %></td>

        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="crudCategorie" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Categories</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Nouveau categorie</h6>
                            <form action="insertionCategorie" method="get">
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">types</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="types" >
                                    </div>
                                </div>
                            ...
                            <h6 class="mb-4">Listes des categories</h6>
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><% out.print(categories.elementAt(i).getNom()); %></td>
                                            <td><% out.print(categories.elementAt(i).getCode()); %></td>
                                            <td><% out.print(categories.elementAt(i).getTypes()); %></td>
                                            <td><a href="SupprimerCategorie?idsupprimer=<% out.print(categories.elementAt(i).getId());%>"><button type="button" class="btn btn-outline-danger m-2">Effacer</button></td></a>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>

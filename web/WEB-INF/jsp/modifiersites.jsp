...
<%
    Vector<Sites> sites= (Vector) request.getAttribute("produitmodifier");
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Modification sites</h6>
                            <form action="acceptmodificationsites" method="get">
                                <input type="hidden" name="idmodifier" value="<% out.print(idmodifier); %>">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nom</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="nom" value="<% out.print(sites.get(0).getNom()); %>">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Accepter la modification</button>
                                <a href="crudSites" class="btn btn-light m-2">Annuler la modification</a>
                            </form>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">sites</h6>
                            <h4>Nom : <% out.print(sites.get(0).getNom()); %> </h4>
                        </div>
                    </div>

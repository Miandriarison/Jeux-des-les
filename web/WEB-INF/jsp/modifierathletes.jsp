...
<%
    Vector<Athletes> athletes= (Vector) request.getAttribute("produitmodifier");
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Modification athletes</h6>
                            <form action="acceptmodificationathletes" method="get">
                                <input type="hidden" name="idmodifier" value="<% out.print(idmodifier); %>">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nom</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="nom" value="<% out.print(athletes.get(0).getNom()); %>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Prenom</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputPassword3" name="prenom" value="<% out.print(athletes.get(0).getPrenom()); %>">
                                    </div>
                                ...
                                <a href="crudAthletes" class="btn btn-light m-2">Annuler la modification</a>
                            </form>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">athletes</h6>
                            <h4>Nom : <% out.print(athletes.get(0).getNom()); %> </h4>
                            <h4>Nombre : <% out.print(athletes.get(0).getPrenom()); %> </h4>
                        </div>
                    </div>

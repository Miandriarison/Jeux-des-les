...
<body>
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <p class="text-center mb-0">Admin ou Utilisateur ? <a href=""></p><br/>
                        <a href="loginadmin"><button type="submit" class="btn btn-primary py-3 w-100 mb-4">Admin</button></a>
                        <a href="loginutilisateur"><button type="submit" class="btn btn-success py-3 w-100 mb-4">Utlisateur</button></a>
                        <a href="publicVoir"><button type="submit" class="btn btn-info py-3 w-100 mb-4">Voir calendrier</button></a>
    ...
    <script src="<% request.getContextPath(); %>assets/cdnjs/jquery.min.js"></script>

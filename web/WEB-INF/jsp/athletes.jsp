...
<%
    Vector<Athletes> athletes= (Vector) request.getAttribute("athletes");
    Vector<Pays> pays= (Vector) request.getAttribute("pays");
    Vector<Genre> genre= (Vector) request.getAttribute("genre");
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="retourModifier" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Liste produit</a>
                    ...
                    <a href="crudAthletes" class="nav-item nav-link active "><i class="fa fa-table me-2"></i>Athletes</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Nouveau Athletes</h6>
                            <form action="insertionAthletes" method="get">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select type="text" class="form-control" id="inputEmail3" name="idgenre">
                                            <% for(int i=0; i<genre.size(); i++) { %>
                                            <option value="<% out.print(genre.elementAt(i).getId()); %>"><% out.print(genre.elementAt(i).getNom()); %></option>
                                            <% } %>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Disciplines</label>
                                    <div class="col-sm-10">
                                        <select type="text" class="form-control" id="inputEmail3" name="iddisciplines">
                                            <% for(int i=0; i<disciplines.size(); i++) { %>
                                            <option value="<% out.print(disciplines.elementAt(i).getId()); %>"><% out.print(disciplines.elementAt(i).getNom()); %></option>
                                            <% } %>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <h6 class="mb-4">Listes des actes</h6>
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><% out.print(v_athletes.elementAt(i).getNom()); %></td>
                                            <td><% out.print(v_athletes.elementAt(i).getPrenom()); %></td>
                                            <td><% out.print(v_athletes.elementAt(i).getGenre()); %></td>
                                            <td><% out.print(v_athletes.elementAt(i).getDisciplines()); %></td>
                                            <td><% out.print(v_athletes.elementAt(i).getPays()); %></td>
                                            <td><a href="modifierathletes?idmodifier=<% out.print(pays.elementAt(i).getId());%>"><button type="button" class="btn btn-outline-warning m-2">Modifier  </button></a></td>
                                            <td><a href="SupprimerAthletes?idsupprimer=<% out.print(v_athletes.elementAt(i).getId());%>"><button type="button" class="btn btn-outline-danger m-2">Effacer</button></td></a>
                                        </tr>
                                        <% } %>

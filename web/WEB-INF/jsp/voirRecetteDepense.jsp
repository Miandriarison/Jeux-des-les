<%-- 
    ...
    Author     : miand
--%>
<%@page import="modele.TableauFinal"%>
<%@page import="modele.V_medailles"%>
<%@page import="java.util.Vector"%>
<%
    Vector<TableauFinal> tableauFinal = (Vector) request.getAttribute("tableauFinal");
%> 
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="crudRDD" class="nav-item nav-link active"><i class= "fa fa-table me-2"></i>  recettes et dépenses par discipline</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tableau des recettes et dépenses par discipline</h6>
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><% out.print(tableauFinal.elementAt(i).getDisciplines()); %></td>
                                            <td><% out.print(tableauFinal.elementAt(i).getRecette()); %></td>
                                            <td><% out.print(tableauFinal.elementAt(i).getDepense()); %></td>
                                            <td><% out.print(tableauFinal.elementAt(i).mamadikaDifference()); %></td>

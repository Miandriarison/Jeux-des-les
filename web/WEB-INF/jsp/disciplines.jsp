        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="crudDisciplines" class="nav-item nav-link active "><i class="fa fa-table me-2"></i>Discipline</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Nouveau Discipline</h6>
                            <form action="insertionDisciplines" method="get">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nom discipline</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Types</label>
                                    <div class="col-sm-10">
                                        <select type="text" class="form-control" id="inputEmail3" name="etat">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><% out.print(disciplines.elementAt(i).getNom()); %></td>
                                            <td><% out.print(disciplines.elementAt(i).getCode()); %></td>
                                            <td>
                                                <% if ( disciplines.elementAt(i).getEtat()== 1 ) { %>
                                                    <% out.print("Indivudiel"); %>
                                                <% } else { %>
                                                    <% out.print("Collectif"); %>
                                                <% } %>
                                            </td>
                                            <td><a href="modifierDisciplines?idmodifier=<% out.print(disciplines.elementAt(i).getId());%>"><button type="button" class="btn btn-outline-warning m-2">Modifier  </button></a></td>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>

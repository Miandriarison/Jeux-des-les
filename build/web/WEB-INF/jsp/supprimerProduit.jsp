<%-- 
    ...
    Created on : 14 juin 2023, 21:52:35
    Author     : Nomena
--%>
...
<%
    Vector<Produit> produit= (Vector) request.getAttribute("produitsupprimer");
    int idsupprimer = (Integer)request.getAttribute("idsupprimer");
%>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4"></h6>
                            <form action="okSupprimerProduit" method="get">
                                <input type="hidden" name="idsupprimer" value="<% out.print(idsupprimer); %>">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <h1>Vous voulez supprimer (<% out.print(produit.get(0).getNom()); %>) vraiment?</h1>
                                    </div>
                                </div>
                                    <center><button type="submit" class="btn btn-primary">Oui</button>
                                <a href="retourModifier" class="btn btn-light m-2">Non</a></center>
                            </form>

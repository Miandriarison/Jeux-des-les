        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="crudSites" class="nav-item nav-link active "><i class="fa fa-table me-2"></i>Sites</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="insertionSites" method="get">
                                <div class="row mb-3">
                            ...
                            <h6 class="mb-4">Listes des sites</h6>
                            <div class="table-responsive">
                                
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">Nom sites</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <% for(int i=0; i<sites.size(); i++) { %>
                                        <tr>
                                            <td><% out.print(sites.elementAt(i).getNom()); %></td>
                                            <td><a href="modifiersites?idmodifier=<% out.print(sites.elementAt(i).getId());%>"><button type="button" class="btn btn-outline-warning m-2">Modifier  </button></a></td>
                                        </tr>
                                        <% } %>

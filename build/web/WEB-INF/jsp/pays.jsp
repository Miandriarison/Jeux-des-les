        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="crudPays" class="nav-item nav-link active "><i class="fa fa-table me-2"></i>Pays</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Nouveau Pays</h6>
                            <form action="insertionPays" method="get">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nom pays</label>
                                    <div class="col-sm-10">
                            ...
                            <h6 class="mb-4">Listes des pays</h6>
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><% out.print(pays.elementAt(i).getNom()); %></td>
                                            <td><a href="modifierpays?idmodifier=<% out.print(pays.elementAt(i).getId());%>"><button type="button" class="btn btn-outline-warning m-2">Modifier  </button></a></td>
                                        </tr>
                                        <% } %>

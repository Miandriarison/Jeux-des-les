...
<%
    Vector<Disciplines> disciplines= (Vector) request.getAttribute("produitmodifier");
...
<head>
    <meta charset="utf-8">
    <title>modifier disciplines</title>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Modification desciplines</h6>
                            <form action="acceptmodificationDisciplines" method="get">
                                <input type="hidden" name="idmodifier" value="<% out.print(idmodifier); %>">
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nom</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="nom" value="<% out.print(disciplines.get(0).getNom()); %>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Etat</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputPassword3" name="etat" value="<% out.print(disciplines.get(0).getEtat()); %>">
                                    </div>
                                    
                                </div>
                                <button type="submit" class="btn btn-primary">Accepter la modification</button>
                                <a href="crudDisciplines" class="btn btn-light m-2">Annuler la modification</a>
                            </form>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">desciplines</h6>
                            <h4>Nom : <% out.print(disciplines.get(0).getNom()); %> </h4>
                            <h4>etat : <% out.print(disciplines.get(0).getEtat()); %> </h4>
                        </div>
                    </div>

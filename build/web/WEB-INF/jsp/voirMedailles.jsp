<%-- 
    ...
    Author     : miand
--%>
<%@page import="modele.V_medailles"%>
<%@page import="java.util.Vector"%>
<%
    Vector<V_medailles> v_medailles = (Vector) request.getAttribute("v_medailles");
%> 
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="publicVoir" class="nav-item nav-link "><i class= "fa fa-table me-2"></i>Voir les calendriers</a>
                    <a href="publicVoirmedaille" class="nav-item nav-link active"><i class= "fa fa-table me-2"></i> Voir le tableau des médailles</a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">ors</th>
                                            <th scope="col">argents</th>
                                            <th scope="col">bronze</th>
                                            <th scope="col">Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <% for(int i=0; i<v_medailles.size(); i++) { %>
                                        <tr>
                                            <th scope="row"><% out.print(i+1); %></th>
                                            <td><% out.print(v_medailles.elementAt(i).getPays()); %></td>
                                            <td><% out.print(v_medailles.elementAt(i).getOrs()); %></td>
                                            <td><% out.print(v_medailles.elementAt(i).getArgent()); %></td>
                                            <td><% out.print(v_medailles.elementAt(i).getBronze()); %></td>
                                            <td><% out.print(v_medailles.elementAt(i).getTotal()); %></td>

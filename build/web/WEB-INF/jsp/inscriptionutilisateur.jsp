<%-- 
    Document   : inscriptionutilisateur
    Created on : 6 juin 2023, 12:15:05
    Author     : Nomena
--%>
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <p class="text-center mb-0">Inscritpion</p>
                        <form action="insertionUtilisateur">
                        ...
                        <div class="form-floating mb-4">
                            <input type="password" name="motdepasse" class="form-control" id="floatingPassword" placeholder="Password">
